...
<div class="snake-wrap">
  ...
  <div class="snake-panel" id="behPanel">
    ...
    <div class="snake-panel-section"><strong>Remaining gap:</strong> <span id="behGap">General classification theory; not specific to off-road perception or robot behavior.</span></div>
</div>
...
<div class="snake-wrap">
  <div class="snake-tl" id="fastcTl">
    ...
    <div class="snake-item s-right snake-active"
      ...
      data-contribution="Learns features directly from unordered point sets using shared MLPs and symmetric pooling."
      data-gap="PointNet is a point-level encoder, but by itself it does not provide an efficient BEV traversability map or temporal completion.">
    ...
    <div class="snake-item s-left"
      ...
      data-contribution="Introduced mechanisms for emphasizing informative channels, spatial regions, and long-range dependencies."
      data-gap="These attention modules are general vision components; they are not designed specifically for aligned multi-frame LiDAR traversability fusion.">
    ...
    <div class="snake-item s-right"
      ...
      data-contribution="Converts point clouds into vertical pillars and scatters learned pillar features into a 2D BEV pseudo-image."
      data-gap="PointPillars is efficient, but it was mainly designed for object detection, not dense off-road traversability completion.">
    ...
    <div class="snake-item s-left"
      ...
      data-contribution="Uses dilated convolutions and a lightweight decoder for efficient real-time semantic segmentation."
    ...
    <div class="snake-item s-right"
      ...
      data-contribution="Predicts BEV terrain cost maps from LiDAR for off-road navigation using geometry, semantics, temporal aggregation, and completion."
      data-gap="BEVNet is the closest predecessor, but its 3D convolutions and recurrent temporal fusion make the model heavier and slower.">
      <span class="snake-year">2022</span>
  ...
  <div class="snake-panel" id="fastcPanel">
    ...
    <div class="snake-panel-section"><strong>Contribution:</strong> <span id="fp2Contribution">Learns features directly from unordered point sets using shared MLPs and symmetric pooling.</span></div>
    <div class="snake-panel-section"><strong>Remaining gap:</strong> <span id="fp2Gap">PointNet is a point-level encoder, but by itself it does not provide an efficient BEV traversability map or temporal completion.</span></div>
  </div>
</div>
...
<div class="snake-wrap">
  ...
  <div class="snake-panel" id="snakePanel">
    ...
    <div class="snake-panel-section"><strong>Remaining gap:</strong> <span id="spGap">Works mainly as an image-space segmentation method; it does not address BEV traversability, temporal mapping, or risk-sensitive terrain cost.</span></div>
  </div>
</div>

...
<div style="display:flex; gap:24px; justify-content:center; align-items:flex-start;">
  <figure style="text-align:center; flex:1; margin:0;">
    <img src="structured_env.png" style="width:100%; max-height:420px; object-fit:contain;">
    <figcaption>Zhang, Bo, et al. "Autonomous vehicles traversability mapping fusing semantic–geometric in off-road navigation." Drones 8.9 (2024): 496.</figcaption>
  </figure>
  <figure style="text-align:center; flex:1; margin:0;">
    <img src="structured_envr.png" style="width:100%; max-height:420px; object-fit:contain;">
...
Different attention mechanisms and activations and optimization methods has not been tested with Fastc or RAC-BEVNet.
...
1. **Quantitative mismatch analysis** between mIoU and behavioral risk
2. **Behavior-aware evaluation metric(s)** such as weighted IoU variants
3. **Improved LiDAR-based models** based on FASTC-style and BEVNet-style designs
4. **Perception-to-hazard-to-heading pipeline** for end-to-end validation
...
| **Paper** | **Method** | **RELLIS-3D mIoU** |
|---|---|---:|
| FASTC | FASTC-S | 61.7% |
| FASTC | FASTC-M | 68.6% |
| RAC-BEVNet | Proposed method | 66.2% |
...
![](flowchart_risk_aware.svg){width=90% fig-align="center"}


##  Fast Attentional Framework for Semantic Traversability Classification Using Point Cloud (FASTC)

![](Fastc_flowchart.svg){width=90% fig-align="center"}


## RAC-BEVNet = Residual-Attention-ConvGRU BEVNet

![](RSCA-ConvGRU.svg){width=90% fig-align="center"}

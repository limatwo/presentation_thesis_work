...
![](pipeline.svg){width=200% fig-align="center"}
...
<!-- END: Results from Latest Literature -->
...
2. Identifying the gap where  different attention mechanisms and optimization methods has not been tested with FASTC or RAC-BEVNet.
